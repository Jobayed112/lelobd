<div class="container mx-auto p-4">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <!-- Company Name -->
        <h1 class="text-3xl font-bold text-center text-indigo-700 mb-6">Lelobd.com</h1>
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="space-y-4 text-right w-full md:w-1/2">
                <!-- Invoice Number -->
                <p class="text-gray-700"><strong>Invoice:</strong> {{ $invoice->invoice_number }}</p>
        ...
        <div class="text-center mt-6">
            <a href="{{ url('/') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300">Back to Home</a>
        </div>
