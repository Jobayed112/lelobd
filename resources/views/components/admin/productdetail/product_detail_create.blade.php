...
<div class="max-w-5xl mx-auto mt-10">
    <div class="bg-gradient-to-br from-blue-50 to-purple-50 shadow-xl rounded-3xl p-6 border border-gray-300">
        <div class="flex justify-between items-center mb-5">
            <h2 class="text-3xl font-extrabold text-blue-800">Create Product Details</h2>
        ...
        <form action="{{ route('product.detail.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-3 gap-4">
            @csrf
