<div class="max-w-5xl mx-auto mt-10">
    <div class="bg-gradient-to-br from-blue-50 to-purple-50 shadow-xl rounded-3xl p-6 border border-gray-300">
        <div class="flex justify-between items-center mb-5">
            <h2 class="text-3xl font-extrabold text-blue-800">Create Product</h2>
            <a href="{{ route('product-list') }}" class="bg-purple-600 text-white px-4 py-2 rounded-lg shadow hover:bg-purple-700 transition">
                ↩️ Back to Products
            </a>
        </div>
        ...
        <form action="{{ route('product-store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-3 gap-4">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-green-500 focus:outline-none text-gray-800" required>
            </div>

            <!-- Description (Takes 3 columns) -->
            <div class="flex flex-col col-span-3">
                <label for="description" class="mb-1 text-sm font-medium text-gray-700">Description</label>
                <textarea id="description" name="description" rows="3" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-purple-500 focus:outline-none text-gray-800" required>{{ old('description') }}</textarea>
            </div>
            ...
            <div class="col-span-3 grid grid-cols-4 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" id="quantity" name="quantity" value="{{ old('quantity') }}" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800" required>
                </div>

                <!-- Price -->
                <div class="flex flex-col">
                    <label for="price" class="mb-1 text-sm font-medium text-gray-700">Price</label>
                    <input type="number" id="price" name="price" value="{{ old('price') }}" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-gray-800" required>
                </div>

                <!-- Product Type -->
                <div class="flex flex-col">
                    <label for="type" class="mb-1 text-sm font-medium text-gray-700">Product Type</label>
                    <select id="type" name="type" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-pink-500 focus:outline-none text-gray-800" required>
                ...
                <div class="flex flex-col">
                    ...
                    <select id="stock" name="stock" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-yellow-500 focus:outline-none text-gray-800" required>
            ...
            <div class="col-span-3 grid grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <input type="file" id="img_url" name="img_url" accept="image/*" class="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-teal-500 focus:outline-none">
                </div>
                <div class="flex flex-col">
                    <img id="img_urlPreview" src="" alt="Image Preview" class="hidden w-40 h-40 object-cover border border-gray-300 rounded-xl">
                </div>
            </div>
