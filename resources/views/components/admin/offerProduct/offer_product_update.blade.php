<div class="max-w-2xl mx-auto mt-10">
    <div class="bg-gradient-to-br from-blue-50 to-purple-50 shadow-xl rounded-3xl p-6 border border-gray-300">
        ...
        <div class="flex justify-between items-center mb-6 flex-wrap">
            <h1 class="text-4xl font-extrabold text-gray-800 w-full sm:w-auto">Edit Product Offer</h1>
        ...
        <form action="{{ route('offer.update', $offer->id) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-3 gap-5 mb-5">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" id="offer_name" name="offer_name" value="{{ old('offer_name', $offer->offer_name) }}"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" id="discount" name="discount" value="{{ old('discount', $offer->discount) }}" step="0.01" min="0"
                        max="100"
