@if (Auth::user())
    <div class="container mx-auto px-6 py-12">
        <!-- Profile Section -->
        <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-300 mb-8">
            ...
            <div class="border-t border-gray-300 mt-8 pt-6">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300 w-full">Save
                            Changes</button>
                    </div>
                </form>
            </div>
            ...
            <div class="border-t border-gray-300 mt-8 pt-6">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mt-6">
                        <button type="submit"
                            class="bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300 w-full">Change
                            Password</button>
                    </div>
                </form>
            </div>
