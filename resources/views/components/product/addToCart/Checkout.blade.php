<div class="container mx-auto px-6 py-10">
    <h1 class="text-4xl font-bold text-gray-900 mb-2 text-center">Checkout</h1>
...
<div class="bg-white p-8 rounded-lg shadow-lg border border-gray-300 lg:col-span-2">
    <h3 class="text-2xl font-semibold text-gray-800 mb-2">Billing & Payment</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-2">
                ...
                <input type="text" id="phone" name="phone"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Enter your phone number" value="+8801" required oninput="enforcePrefix()">
            </div>
...
<script>
    function enforcePrefix() {
        ...
        if (!phoneInput.value.startsWith("+8801")) {
